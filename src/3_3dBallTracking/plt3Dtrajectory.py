...
from utils.particleFilter3D import ParticleFilter
...
def plot_trajectory(interp_frames, interp_xs, interp_ys, interp_zs, trajectory, action_number):
    """
    ...
    # Plot smoothed trajectory and detections
...
def main():
    ...
    interp_frames, interp_xs, interp_ys, interp_zs = smooth_trajectory(trajectory)

    plot_trajectory(interp_frames, interp_xs, interp_ys, interp_zs, trajectory, action_number)

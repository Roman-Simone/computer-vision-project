...
from utils.yoloWindows import yoloWindow
...
def is_in_any_region(x_center, y_center, regions):
    ...
    parameters:
        x_center (float): the x-coordinate of the point to be checked.
        y_center (float): the y-coordinate of the point to be checked.
...
def applyModel(frame, model, regions):
    ...
    filtering out any detections within specified regions.
    ...
    if camera_number != 2:
        ...
        # apply a different model method for camera 2, with visualization enabled
